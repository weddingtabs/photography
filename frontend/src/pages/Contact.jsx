...
const INFO_CARDS = [
  {
    ...
    lines: ['+91 70930 93440', 'Mon–Sat, 10am–7pm'],
  },
  {
    icon: Mail,
    title: 'Email',
    lines: ['hello@dreammoments.studio', 'We reply within 24 hours'],
  },
  {
    icon: MapPin,
    title: 'Studio Address',
    lines: ['123 Creative Lane, Andheri West', 'Mumbai, Maharashtra 400053'],
  },
  {
    icon: Clock,
    title: 'Working Hours',
